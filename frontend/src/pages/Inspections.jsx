...
import { inspectionApi, extinguisherApi } from '../api/services';
...
export default function Inspections() {
  ...
  const [form, setForm] = useState({ fireExtinguisher: '', inspectionDate: '', inspectionTime: '09:00' });
  ...
  useEffect(() => {
    ...
    extinguisherApi
      ...
      .then((res) => setExtinguishers(res.data.data || []))
  ...
  const openSchedule = () => {
    ...
    setFieldErrors(null);
    setSuccessMsg(null);
    setForm({ fireExtinguisher: '', inspectionDate: '', inspectionTime: '09:00' });
    setModal(true);
  };
  ...
  const schedule = async (e) => {
    ...
    try {
      const payload = {
        ...form,
        inspectionDate: form.inspectionDate.includes('T')
          ? form.inspectionDate
          : `${form.inspectionDate}T12:00:00.000Z`,
      };
      await inspectionApi.schedule(payload);
      setModal(false);
            ...
            <form className="mt-4 space-y-3" onSubmit={complete}>
              ...
              <div>
                ...
                <input
                  className="input-field"
                  required
                  placeholder="e.g. Pass, Fail, Needs service"
