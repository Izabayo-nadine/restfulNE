...
export const authApi = {
  ...
  registerVerifyOtp: (email, otp) =>
    client.post('/auth/register/verify-otp', { email: email.trim().toLowerCase(), otp: String(otp).trim() }),
  ...
  forgotPasswordSendOtp: (email) => client.post('/auth/forgot-password/send-otp', { email }),
  forgotPasswordReset: (data) => client.post('/auth/forgot-password/reset', data),
...
export const reportApi = {
  inventory: (period) => client.get('/reports/inventory', { params: { period } }),
